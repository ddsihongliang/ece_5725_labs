...
# “Start” and “Quit” are implemented as level 1 menu. Screen coordinates should
# be displayed if hits occur outside of start and quit buttons. Once the
# animation begins to play, a second level of button controls, shown above on
# the ’level 2’ menu, should be displayed including the following buttons and
# associated functions: Pause/restart: pause a running animation. Restart a
# paused animation. Faster: speed up the animation by a fixed amount.
# Slower: slow the animation by a fixed amount. Back: stop the animation and
# return to the ‘top’ menu screen which implements the start and quit buttons.
#****************************************
import pygame
